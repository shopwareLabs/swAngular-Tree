    ...
    .directive('swAngularTree', function ($sce, $http, $compile) {
        ...
        return {
            ...
            template: [
                ...
                '            <input type="checkbox" ng-show="options.showCheckbox" ng-model="node.checked" ng-click="checkboxClick(node, node.checked!=true)" ng-disabled="(node.checked && !options.enableChecked) || (!node.checked && !options.enableUnchecked)"/>',
                ...
                '            <input type="checkbox" ng-show="options.showCheckbox || options.showCheckboxOnLeaf" ng-model="node.checked" ng-click="checkboxClick(node, node.checked!=true)" ng-disabled="(node.checked && !options.enableChecked) || (!node.checked && !options.enableUnchecked)"/>',
